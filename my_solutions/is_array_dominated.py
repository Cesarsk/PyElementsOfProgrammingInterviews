...
class Team:
    ...
    def valid_placement_exists(team0: 'Team', team1: 'Team') -> bool:
        # zip matches element of two teams like (t0_p0,t1_p0),(t0_p1,t1_p1), ...
        zipped = zip(sorted(team0._players), sorted(team1._players))
        for t0_player, t1_player in zipped:
            if t0_player >= t1_player:  # t0_player must be shorter than t1_player to be placed IN FRONT
                return False
        return True
